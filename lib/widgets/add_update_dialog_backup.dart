...
class _AddUpdateDialogState extends State<AddUpdateDialog> {
  ...
  void initState() {
    ...
    _descriptionController = TextEditingController(
      text: widget.initialUpdate?.description ?? '',
    );
    ...
    _userFeedbackController = TextEditingController(
      text: widget.initialUpdate?.userFeedback ?? '',
    );
    ...
    if (widget.initialUpdate != null) {
      ...
      _changesList.addAll(widget.initialUpdate!.changes);
      _filesList.addAll(widget.initialUpdate!.affectedFiles);
    }
  }
    );
